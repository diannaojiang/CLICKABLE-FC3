...
elements["PNT_CTM_CHAFF"]           = default_button("反制措施 金属碎片 释放",                      devices.CLICKABLE,  device_commands.CLIC_CTM_CHAFF     )
elements["PNT_CTM_FLARE"]           = default_button("反制措施 热焰弹 释放",                     devices.CLICKABLE,  device_commands.CLIC_CTM_FLARE     )
elements["PNT_AUTO_DAMPER"]         = default_button("自动驾驶仪 - 阻尼器",                                  devices.CLICKABLE,  device_commands.CLIC_AUTO_DAMPER   )
elements["PNT_AUTO_ATT_HOLD"]       = default_button("自动驾驶仪 - 姿态保持",                           devices.CLICKABLE,  device_commands.CLIC_AUTO_ALT      )
elements["PNT_AUTO_ALT_HOLD"]       = default_button("自动驾驶仪 - 过渡到水平飞行控制",      devices.CLICKABLE,  device_commands.CLIC_AUTO_LEVEL    )
...
elements["PNT_UNLOCK"]              = default_button("目标解锁",                                       devices.CLICKABLE,  device_commands.CLIC_LOCK_REL      )
elements["PNT_LOCK"]                = default_button("目标锁定",                                         devices.CLICKABLE,  device_commands.CLIC_LOCK          )
elements["PNT_UNLOCK_STICK"]        = default_button("目标锁定",                                         devices.CLICKABLE,  device_commands.CLIC_LOCK_REL      )
elements["PNT_AUTO_LEVEL_STICK"]    = default_button("自动驾驶仪 - 过渡到水平飞行控制",      devices.CLICKABLE,  device_commands.CLIC_AUTO_LEVEL    )
elements["PNT_AUTO_RESET_STICK"]    = default_button("自动驾驶仪复位",                                     devices.CLICKABLE,  device_commands.CLIC_AUTO_STOP     )
elements["PNT_MIRROR_U"]            = default_button("切换后视镜",                                      devices.CLICKABLE,  device_commands.CLIC_MIRROR        )
elements["PNT_MIRROR_L"]            = default_button("切换后视镜",                                      devices.CLICKABLE,  device_commands.CLIC_MIRROR        )
elements["PNT_MIRROR_R"]            = default_button("切换后视镜",                                      devices.CLICKABLE,  device_commands.CLIC_MIRROR        )
elements["PNT_CHUTE_DEP"]           = default_button("降落伞展开",                                devices.CLICKABLE,  device_commands.CLIC_CHUTE_DEP     )  
elements["PNT_CHUTE_REL"]           = default_button("降落伞释放",                                   devices.CLICKABLE,  device_commands.CLIC_CHUTE_REL     )  
elements["PNT_CHUTE_REL_BIS"]       = default_button("降落伞释放",                                   devices.CLICKABLE,  device_commands.CLIC_CHUTE_REL     )  
elements["PNT_DSP_ZOOMIN"]          = default_button("显示放大",			                            devices.CLICKABLE,  device_commands.CLIC_DSP_ZOOMIN    )  
elements["PNT_DSP_ZOOMOUT"]         = default_button("显示缩小",		                            devices.CLICKABLE,  device_commands.CLIC_DSP_ZOOMOUT   )  
elements["PNT_LIGHT"]               = default_button("驾驶舱照明",                                devices.CLICKABLE,  device_commands.CLIC_COCKPITLIGHT  )  
elements["PNT_CTM"]                 = default_button("反制措施持续释放",               devices.CLICKABLE,  device_commands.CLIC_CTM           )
elements["PNT_NAVPROGRAM"]          = default_axis_limited("导航模式",                              devices.CLICKABLE,  device_commands.CLIC_NAVMODES      )  
...
elements["PNT_RADAR_MODE"]          = default_button("雷达 RWS/TWS 模式选择",                           devices.CLICKABLE,  Keys.iCommandPlaneRadarChangeMode    )
elements["PNT_RADAR_MODE"].stop_action        = nil
elements["PNT_RADAR_FREQ"]          = default_button("雷达脉冲重复频率选择",                 devices.CLICKABLE,  device_commands.CLIC_RADAR_FREQ    )  
elements["PNT_DIRECT_CONTROL"]      = default_button("ASC直接控制（眼镜蛇）",                          devices.CLICKABLE,  device_commands.CLIC_ASC_DC        )
elements["PNT_AIRBRAKE"]            = default_button("空气制动器",                                            devices.CLICKABLE,  device_commands.CLIC_AIRBRAKE      )
elements["PNT_CTM_ONCE"]            = default_button("反制措施释放",                             devices.CLICKABLE,  device_commands.CLIC_CTM_ONCE      )
elements["PNT_UNLOCK"]              = default_button("目标解锁",                                       devices.CLICKABLE,  device_commands.CLIC_LOCK_REL      )
elements["PNT_LOCK"]                = default_button("目标锁定",                                         devices.CLICKABLE,  device_commands.CLIC_LOCK          )
elements["PNT_STATION"]             = default_button("武器更换",                                       devices.CLICKABLE,  device_commands.CLIC_STATION       )
elements["PNT_AUTO_LEVEL_STICK"]    = default_button("自动驾驶仪 - 过渡到水平飞行控制",      devices.CLICKABLE,  device_commands.CLIC_AUTO_LEVEL    )
elements["PNT_AUTO_RESET_STICK"]    = default_button("自动驾驶仪复位",                                     devices.CLICKABLE,  device_commands.CLIC_AUTO_STOP     )
elements["PNT_MIRROR_U"]            = default_button("切换后视镜",                                      devices.CLICKABLE,  device_commands.CLIC_MIRROR        )
elements["PNT_MIRROR_L"]            = default_button("切换后视镜",                                      devices.CLICKABLE,  device_commands.CLIC_MIRROR        )
elements["PNT_MIRROR_R"]            = default_button("切换后视镜",                                      devices.CLICKABLE,  device_commands.CLIC_MIRROR        )
elements["PNT_RWR_SOUND_BIS"]       = default_axis_limited("RWR/SPO 声音信号音量 增大/减小",			devices.CLICKABLE,  device_commands.CLIC_RWR_SOUND,nil, 0, 1,true,true)
elements["PNT_DSP_ZOOMIN"]          = default_button("显示放大",			                            devices.CLICKABLE,  device_commands.CLIC_DSP_ZOOMIN    )  
elements["PNT_DSP_ZOOMOUT"]         = default_button("显示缩小",		                            devices.CLICKABLE,  device_commands.CLIC_DSP_ZOOMOUT   )  
elements["PNT_HUD_REP"]             = default_button("HDD、HUD中继器模式 开/关",                       devices.CLICKABLE,  device_commands.CLIC_HUD_REPEATER  )
elements["PNT_ENG_INLET"]           = default_button("发动机进气格栅 自动/关闭",                         devices.CLICKABLE,  device_commands.CLIC_ENG_INLET     )  
elements["PNT_SCAN_L"]              = default_button("扫描区 向左",                                      devices.CLICKABLE,  device_commands.CLIC_SCAN_L        )
elements["PNT_SCAN_R"]              = default_button("扫描区 向右",                                     devices.CLICKABLE,  device_commands.CLIC_SCAN_R        )
elements["PNT_SCAN_U"]              = default_button("扫描区 向上",                                        devices.CLICKABLE,  device_commands.CLIC_SCAN_U        )
elements["PNT_SCAN_D"]              = default_button("扫描区 向下",                                      devices.CLICKABLE,  device_commands.CLIC_SCAN_D        )
elements["PNT_LIGHT"]               = default_button("驾驶舱照明",                                devices.CLICKABLE,  device_commands.CLIC_COCKPITLIGHT  )  
elements["PNT_CTM"]                 = default_button("反制措施持续释放",               devices.CLICKABLE,  device_commands.CLIC_CTM           )
elements["PNT_LANDING_LIGHTS"]      = default_button("前轮灯 近/远/关闭",                             devices.CLICKABLE,  device_commands.CLIC_LANDING_LIGHTS)
elements["PNT_NAVPROGRAM"]          = default_axis_limited("导航模式",                              devices.CLICKABLE,  device_commands.CLIC_NAVMODES      )  
